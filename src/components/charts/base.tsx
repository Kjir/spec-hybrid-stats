...
export default function Base(): JSX.Element {
    ...
    return (
        <Fragment>
            ...
            <p>Welcome to the "Specialist Cup in Stats - Hybrid Division" website. This website collects all the statistics you could ever want to know about the tournament in one place!</p>
            <p>The data, by default summarizes the entire tournament (as of 2024.09.11). Use the filters on the toolbar to view the data pertaining to a particular group, map or bracket.</p>
            ...
            <hr></hr>
            Thanks for checking out Specialist Cup in Stats - Hybrid Division!
        </Fragment>
    );
}
