...
export default function Base(): JSX.Element {
    ...
    return (
        <Fragment>
            ...
            <p>The data, by default summarizes the entire tournament (as of 2024.12.01). Use the filters on the toolbar to view the data pertaining to a particular group, map or bracket.</p>
